...
class buddydetails extends StatefulWidget {
  const buddydetails({super.key});

  @override
  State<buddydetails> createState() => _buddydetailsState();
}

class _buddydetailsState extends State<buddydetails> {
  @override
                          ...
                          Container(
                            ...
                            decoration: const BoxDecoration(
                                ...
                                image: DecorationImage(
                                  image:
                                      AssetImage(ShareRideAssets.andummyimage),
                                  fit: BoxFit.cover,
                                )),
                          ),
                          const SizedBox(
